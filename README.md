...
Summary: Type annotations for aiobotocore.CloudFormation 3.9.1 service generated with mypy-boto3-builder
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/types-aiobotocore-cloudformation-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/types-aiobotocore-cloudformation-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add types-aiobotocore-cloudformation
# for installing globally
pixi global install types-aiobotocore-cloudformation
```
...
It is possible to list all of the versions of `types-aiobotocore-cloudformation` available on your platform:
...
```
pixi search types-aiobotocore-cloudformation --channel conda-forge
```
